...
('description', 's:30:"WeCenter 社交化知識社區";'),
('keywords', 's:47:"WeCenter,知識社區,社交社區,問答社區";'),
('sensitive_words', 's:0:"";'),
...
('reputation_function', 's:78:"[最佳答案]*3+[贊同]*1-[反對]*1+[發起者贊同]*2-[發起者反對]*1";'),
...
('site_close', 's:1:"N";'),
('close_notice', 's:39:"站點已關閉，管理員請登錄。";'),
...
('welcome_message_pm', 's:180:"尊敬的{username}，您已經註冊成為{sitename}的會員，請您在發表言論時，遵守當地法律法規。\n如果您有什麼疑問可以聯繫管理員。\n\n{sitename}";'),
('time_style', 's:1:"Y";'),
